            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav ms-auto">
						...
						<a class="nav-link" href="index.php">Componentes</a>						
                                ...
                                <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <th><?php  echo $row['envase']?></th>    
                                                <th><?php  echo $row['cantidad']?></th>    
                                                <th><?php  echo "$".$row['precio']?></th>    
                                                <th><?php  echo $row['tasa_iva']."%"?></th>    
                                                <th><?php  echo "$".$row['iva']?></th>    
                                                <th><?php  echo "$".$row['importe_final']?></th>    
										...
										if($row['cantidad']>=7 && $row['cantidad']<=10)
												...
												if($row['cantidad']>=3 && $row['cantidad']<=6)
													{
														?>
														<script>
																Push.create("¡Poco stock del Componente <?php echo $row['codigo']?>!",{
